...
buttons["Character"].MouseButton1Click:Connect(antiVoid)
...
-- Misc Section Example: Freeze First Player
...
local function antiVCBan()
    print("Anti VC Ban active")
end
buttons["Communication"].MouseButton1Click:Connect(antiVCBan)

print("⚡ Ayush Full Panel Loaded ⚡")
