-- ⚡ Ayush Full CoreGui Admin Panel (Password once + Draggable) ⚡
...
local HEADSIT_ANIM_ID = "rbxassetid://591872667" -- replace with your headsit anim id if needed
-- ====================
...
-- Create or get unlock flag (persists for session)
...
broadcastBtn.MouseButton1Click:Connect(function()
    local success, err = pcall(function()
        ...
        if msgEvent and msgEvent:FindFirstChild("SayMessageRequest") then
            ...
            -- fallback attempt (some games differ)
